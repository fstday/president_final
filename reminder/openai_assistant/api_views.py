...
def determine_user_intent(user_input, context=None):
    ...
    if booking_score > max(check_score, info_score):
        ...
        # Add this to the intent detection function
        if time_str:
            try:
